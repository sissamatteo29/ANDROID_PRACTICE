...
class QuotationListAdapter : ListAdapter<Quotation, QuotationListAdapter.QuotationViewHolder>(QuotationDiff) {
    ...
    }   // object QuotationDiff

    /**
     * ViewHolder class dedicated to a Quotation that actualises the UI for a single Quotation
     */
    class QuotationViewHolder(private val binding : QuotationItemBinding) : RecyclerView.ViewHolder(binding.root) {
